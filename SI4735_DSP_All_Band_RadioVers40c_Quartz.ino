...
//  V4.0c  - 08.09.2021 Binns Version 4.0 Modified by YO2LDK - Alex for ILI9488 4" TFT LCD
//         - Dual time; day and date added on screen (UTC and Local) useful for HAM bands and many commercial stations;
//           ( you need to modify credentials for wifi connection and time location !!! )
...
void setup() {
  ...
  int16_t si4735Addr = si4735.getDeviceI2CAddress(RESET_PIN);
   WiFi.begin("Your SSID", "Your password");                    //     !!  modify here !!
    setServer(ntp_pool);
    setInterval(7220);
  tft.setRotation(1);
...
btn.onPress(pressHandler)
  ...
  spr.deleteSprite();
  tft.println(" DSP ALL Band ALL Mode Radio SI4735 ");
  delay(400);
